<?php
/**
 * About page — intro decree + vision/mission/objectives + word links.
 *
	...
	<div class="container">
		...
		<div class="about-wrap">
			...
			<div class="about-links">
				<a class="about-link" href="<?php echo esc_url( home_url( '/chairman/' ) ); ?>"><img src="<?php echo $img; ?>/Nashaat2.jpg" alt=""><b data-i18n="aboutp.chairman">كلمة رئيس مجلس الإدارة</b><small data-i18n="aboutp.chairname">أ.د. نشأت عبد الله عبده زين الدين</small></a>
				<a class="about-link" href="<?php echo esc_url( home_url( '/dean/' ) ); ?>"><img src="<?php echo $img; ?>/dean.jpg" alt=""><b data-i18n="aboutp.dean">كلمة عميد المعهد</b><small data-i18n="aboutp.deanname">أ.د. محمد فتحي عزازي</small></a>
			</div>
		</div>
	</div>
</main>
